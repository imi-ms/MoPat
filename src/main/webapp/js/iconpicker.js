...
export default class Iconpicker
{
    constructor(el, options) {
        ...
        this.el.nextElementSibling.querySelectorAll('li').forEach(item => item.addEventListener('click', e => {
            ...
            var inp = this.options.showSelectedIn.parentElement.parentElement.getElementsByTagName('input')[0]
            inp.value = value;
        }))
        ...
        this.el.addEventListener('click', this.focusIn)
