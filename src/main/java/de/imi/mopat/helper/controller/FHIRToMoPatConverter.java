 ...
 */
public class FHIRToMoPatConverter {

    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(
        FHIRToMoPatConverter.class);
    ...
    public static ImportQuestionnaireResult convertFHIRQuestionnaireToMoPatQuestionnaire(
        ...
        if (fhirQuestionnaire.getTitle() != null) {
            ...
            localizedDisplayNames = FHIRHelper.getLanugageMapFromLanguageExtension(
        ...
        if (fhirQuestionnaire.getDescription() != null && !fhirQuestionnaire.getDescription().trim()
            ...
            if (fhirQuestionnaire.getUseContext() != null && !fhirQuestionnaire.getUseContext()
                ...
                try {
                    descriptionText.append(
                        fhirQuestionnaire.getUseContextFirstRep().getValueCodeableConcept()
                            .getText());
        ...
        } else if (fhirQuestionnaire.getTitle() != null && !fhirQuestionnaire.getTitle().trim()
            .isEmpty()) {
        ...
        for (Questionnaire.QuestionnaireItemComponent item : fhirQuestionnaire.getItem()) {
            items.add(item);
            items.addAll(FHIRHelper.getAllItems(item));
        }
    ...
    public static ImportQuestionResult convertItemToQuestion(final Questionnaire questionnaire,
        ...
        if (item.hasOption() || item.hasOptions() || (item.getOptionsTarget() != null
            ...
            if (item.getText() != null) {
                localizedQuestionText = FHIRHelper.getLanugageMapFromLanguageExtension(
                    item.getTextElement());
            ...
            switch (item.getType()) {
                case BOOLEAN:
                    ...
                    String trueExportField =
                        item.getLinkId().replace(".", "u002E").replace("_", "u005F") + "_"
                            + Boolean.TRUE;
                    ...
                    for (String currentLocale : question.getLocalizedQuestionText().keySet()) {
                        localizedAnswerText.put(currentLocale,
                            messageSource.getMessage("survey.question" + ".answer" + ".yes",
                                new Object[]{}, LocaleHelper.getLocaleFromString(currentLocale)));
                    }
                    SelectAnswer selectAnswer = new SelectAnswer(question, question.getIsEnabled(),
                        localizedAnswerText, Boolean.FALSE);
                    selectAnswer.setValue(FHIRHelper.getScoreFromExtension(item));
                    ...
                    for (String currentLocale : question.getLocalizedQuestionText().keySet()) {
                        localizedAnswerText.put(currentLocale,
                            messageSource.getMessage("survey.question" + ".answer.no",
                                new Object[]{}, LocaleHelper.getLocaleFromString(currentLocale)));
                    }
                    selectAnswer = new SelectAnswer(question, question.getIsEnabled(),
                        localizedAnswerText, Boolean.FALSE);
                    selectAnswer.setValue(FHIRHelper.getScoreFromExtension(item));
                    importQuestionResult.addValidationMessage("import.fhir.option.result",
                        new String[]{
                ...
                case OPENCHOICE:
                    ...
                    maxAndMinEntry = FHIRHelper.getMinAndMaxFromExtension(item, true);
                    question.setQuestionType(QuestionType.MULTIPLE_CHOICE);
                        ...
                        if (valueSet != null) {
                            for (ValueSet.ConceptSetComponent conceptComponent : valueSet.getCompose()
                                ...
                                for (ValueSet.ConceptReferenceComponent conceptReference : conceptComponent.getConcept()) {
                                    ...
                                    // mopat answers
                                    convertOptionToAnswer(conceptReference, question,
                                        importQuestionResult, exportTemplates, messageSource,
                                        locale, conceptComponent.getSystem());
                                }
                            }
                        }
                    }
                    ...
                    if (item.getType() == QuestionnaireItemType.OPENCHOICE) {
                        ...
                        importQuestionResult.addValidationMessage(
                            "import.fhir.item.openchoice.otherFreetext");
                    }
                ...
                case DATE:
                    ...
                    Entry<Date, Date> maxAndMinDateEntry = FHIRHelper.getMinAndMaxDateFromExtension(
                        item);
                    ...
                    if (startDate != null && endDate != null && startDate.after(endDate)) {
                        ...
                        endDate = null;
                        importQuestionResult.addValidationMessage(
                            "import.fhir.item.startDateAfterEndDate");
                    }
                ...
                case DECIMAL:
                    ...
                    maxAndMinEntry = FHIRHelper.getMinAndMaxFromExtension(item, false);
                    ...
                    if (minValue != null && maxValue != null) {
                        ...
                        if (minValue >= maxValue) {
                            ...
                            // than max value
                            importQuestionResult.addValidationMessage(
                                "import.fhir.item.minGreaterThanMax",
                    ...
                    if (minValue != null && maxValue != null) {
                        ...
                        if (difference > 0.0D && difference <= 10.0D
                            ...
                            SliderAnswer sliderAnswer = new SliderAnswer(question, true, minValue,
                                maxValue, stepSize, false);
                            ...
                            answer = new NumberInputAnswer(question, question.getIsEnabled(),
    ...
    public static void convertOptionToAnswer(final IBaseBackboneElement option,
        ...
        if (option instanceof Questionnaire.QuestionnaireItemOptionComponent) {
            Questionnaire.QuestionnaireItemOptionComponent item = (Questionnaire.QuestionnaireItemOptionComponent) option;
            try {
                String value = null;
                ...
                if (item.getValue() instanceof Coding) {
                    ...
                    if (item.getValueCoding().getDisplay() != null && !item.getValueCoding()
                        ...
                        localizedAnswerText = FHIRHelper.getLanugageMapFromLanguageExtension(
                            item.getValueCoding().getDisplayElement());
                        List<Extension> lang = item.getValueCoding().getDisplayElement()
                            .getExtensionsByUrl("lang");
                        if (lang != null && lang.size() > 0 && lang.get(0) != null) {
                            localizedAnswerText.put(
                                lang.get(0).getValueAsPrimitive().getValueAsString()
                                    .replace("-", "_"), item.getValueCoding().getDisplay());
                        } else {
                ...
                if (item.getValue() instanceof Coding) {
                    answer.setValue(FHIRHelper.getScoreFromExtension(item.getValueCoding()));
        ...
        } else if (option instanceof ValueSet.ConceptReferenceComponent) {
            ValueSet.ConceptReferenceComponent item = (ValueSet.ConceptReferenceComponent) option;
            ...
            SelectAnswer answer = new SelectAnswer(question, question.getIsEnabled(),
                localizedAnswerText, false);
            answer.setValue(FHIRHelper.getScoreFromExtension(item.getDisplayElement()));
            scoreValue = answer.getValue();
            // Create the exportRules
            for (ExportTemplate exportTemplate : exportTemplates) {
                ExportRuleAnswer exportRuleAnswer = new ExportRuleAnswer(exportTemplate,
    ...
    public static void convertEnableWhenToCondition(
        ...
        QuestionnaireItemComponent triggerItem = FHIRHelper.getItemByLinkId(
