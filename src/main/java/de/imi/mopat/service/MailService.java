...
public class MailService {
    ...
    public MailService(ApplicationMailer applicationMailer, MessageSource messageSource, ConfigurationService configurationService, ConfigurationDao configurationDao) {
    ...
    public MailSendingStatus sendEncounterMail (Encounter encounter){
        boolean success = encounter.sendMail(applicationMailer, messageSource, configurationDao.getBaseURL());
        if (success) return MailSendingStatus.SUCCESS;
        ...
        else return MailSendingStatus.FAILURE;
    }
