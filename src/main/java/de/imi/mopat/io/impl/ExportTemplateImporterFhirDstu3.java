...
public class ExportTemplateImporterFhirDstu3 implements ExportTemplateImporter {
    ...
    private static final org.slf4j.Logger LOGGER =
            org.slf4j.LoggerFactory.getLogger(ExportTemplateImporterFhirDstu3.class);
    ...
    public List<String> importFile(final InputStream inputStream)
        ...
        try {
            Questionnaire questionnaire = (Questionnaire) FhirDstu3Helper.parseResourceFromFile(inputStream);
                        ...
                        case CHOICE:
                            ...
                            if (valueSet != null && valueSet.getCompose() != null) {
                                for (ValueSet.ConceptSetComponent conceptComponent :
                                    ...
                                    for (ValueSet.ConceptReferenceComponent conceptReference :
                                            conceptComponent.getConcept()) {
                                        mappingExportFields.add(
                                                item.getLinkId()
                                                                .replace(".", "u002E")
                                                                .replace("_", "u005F") + "_"
