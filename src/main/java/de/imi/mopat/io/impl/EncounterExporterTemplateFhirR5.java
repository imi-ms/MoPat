...
public class EncounterExporterTemplateFhirR5 implements EncounterExporterTemplate {
    ...
    public void load(final Encounter encounter, final ExportTemplate exportTemplate)
        ...
        questionnaire = (Questionnaire) FhirR5Helper.parseResourceFromFile(
            new FileInputStream(file));
        questionnaireResponse = FhirR5Helper.getQuestionnaireResponse(questionnaire);
    ...
    public void write(final String exportField, final String value) throws Exception {
        ...
        List<QuestionnaireResponseItemAnswerComponent> allAnswers = FhirR5Helper
