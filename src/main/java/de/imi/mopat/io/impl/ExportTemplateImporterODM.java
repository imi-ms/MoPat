    ...
    public List<String> importFile(InputStream inputStream)
        ...
        try {
            ...
            if (studyList == null || studyList.isEmpty()) {
                ...
                LOGGER.debug("At least one Study element in the imported ODM." + " Will take the first one (1. "
                ...
                if (metaDataVersionList == null || metaDataVersionList.isEmpty()) {
                    LOGGER.debug("The imported ODM, first Study element, did " + "not contain any MetaDataVersion "
                    ...
                    if (formDefList == null || formDefList.isEmpty()) {
                        ...
                        LOGGER.debug("At least one FormDef element in the " + "imported ODM, first Study "
                        ...
                        if (itemGroupRefList == null) {
                            LOGGER.debug(
                                    "The FormDef of OID {} did not contain " + "any ItemGroupRefs. Won't "
                                            + "create any question(group)s",
                                    formDef.getOID());
                        } else {
                            LOGGER.debug(
                                    "The FormDef of OID {} contains at least "
                                            + "one ItemGroupRef. Checking for" + " ItemGroupDefs in "
                                            + "MetaDataVersion of OID {} now.",
                                    formDef.getOID(),
                                    metaDataVersion.getOID());
                            List<ODMcomplexTypeDefinitionItemGroupDef> itemGroupDefList =
                            ...
                            if (itemGroupDefList == null || itemGroupDefList.isEmpty()) {
                                ...
                                for (ODMcomplexTypeDefinitionItemGroupRef itemGroupRef : itemGroupRefList) {
                                    ...
                                    for (ODMcomplexTypeDefinitionItemGroupDef itemGroupDef : itemGroupDefList) {
                                        LOGGER.debug(
                                                "Now checking the " + "ItemGroupDef with "
                                ...
                                for (ODMcomplexTypeDefinitionItemGroupRef itemGroupRef : matchedItemGroupRefs) {
                                    ...
                                    if (orderNumber == null) {
                                        ...
                                        if (orderedItemGroupDefs.get(orderNumber.intValue()) == null) {
                                            LOGGER.debug(
                                                    "The List of ItemGroupDefs has a free spot at position/OrderNumber"
                                                            + " {}, so I'll just put the ItemGroupDef of OID {} there.",
                                                    orderNumber.intValue(),
                                                    itemGroupRef.getItemGroupOID());
                                            ...
                                            LOGGER.debug(
                                                    "The List of ItemGroupDefs already has an ItemGroupDef at"
                                                        + " position/OrderNumber {}, which does not comply to the ODM"
                                ...
                                if (orderNumberForAllItemGroupRefsPresent) {
                                    LOGGER.debug(
                                            "All ItemGroupDefs of " + "MetaDataVersion "
                                    ...
                                    LOGGER.debug(
                                            "Not all ItemGroupDefs of " + "MetaDataVersion "
                                                    + "of OID {} that " + "were referenced "
                                                    + "in FormDef of OID" + " {} have a unique"
                                                    + " OrderNumber in " + "their " + "ItemGroupRef. "
                                ...
                                LOGGER.debug(
                                        ...
                                        formDef.getOID());
                                for (ODMcomplexTypeDefinitionItemGroupDef itemGroupDef :
                                        itemGroupDefListToIterateOver) {
                                    LOGGER.debug(
                                            "Checking the list of ItemRefs " + "for ItemGroupDef of " + "OID {}",
                                            itemGroupDef.getOID());
                                    ...
                                    if (itemRefList == null || itemRefList.isEmpty()) {
                                        ...
                                        LOGGER.debug(
                                                ...
                                                itemGroupDef.getOID(),
                                                metaDataVersion.getOID());
                                        List<ODMcomplexTypeDefinitionItemDef> itemDefList =
                                        ...
                                        if (itemDefList == null || itemDefList.isEmpty()) {
                                            ...
                                            LOGGER.debug(
                                                    ...
                                                    metaDataVersion.getOID(),
                                                    itemGroupDef.getOID());
                                            Map<ODMcomplexTypeDefinitionItemRef, ODMcomplexTypeDefinitionItemDef>
                                                    matchingItemRefDefs = new HashMap<>();
                                            ...
                                            for (ODMcomplexTypeDefinitionItemRef itemRef : itemRefList) {
                                                ...
                                                for (ODMcomplexTypeDefinitionItemDef itemDef : itemDefList) {
                                                    LOGGER.debug(
                                                            "Now checking the ItemDef with OID {} for equality with"
                                                                    + " ItemRef of ItemOID {}",
                                                            itemDef.getOID(),
                                                            itemRef.getItemOID());
                                                    if (refItemOID.equalsIgnoreCase(itemDef.getOID())) {
                                                        LOGGER.debug(
                                                                "ItemDef with OID {} matched the reffered OID. Will"
                                                                        + " put it into the list of ItemDefs to make"
                                                                        + " Question out of",
                                                                itemDef.getOID());
                                                ...
                                                if (!itemRefFoundInItemDef) {
                                                    LOGGER.debug(
                                                            "Iteration over ItemDefs in MetaDataVersion of OID {}"
                                                                    + " done. No ItemDef for the ItemRefOID {} could be"
                                                                    + " found. The ItemRef/-Def will not be"
                                                                    + " converted/considered.",
                                                            metaDataVersion.getOID(),
                                                            itemRef.getItemOID());
                                                }
                                            }
                                            LOGGER.debug(
                                                    "Iteration over " + "ItemRefs " + "in "
                                            ...
                                            Map<Integer, ODMcomplexTypeDefinitionItemDef> orderedItemDefs =
                                                    new HashMap<>();
                                            for (ODMcomplexTypeDefinitionItemRef itemRef : matchedItemRefs) {
                                                LOGGER.debug(
                                                        "Now checking for an " + "OrderNumber " + "for " + "ItemRef of"
                                                                + " OID {}",
                                                        itemRef.getItemOID());
                                                BigInteger orderNumber = itemRef.getOrderNumber();
                                                if (orderNumber == null) {
                                                    LOGGER.debug(
                                                            "The ItemRef with OID {} does not have an OrderNumber, so"
                                                                + " I'll write an error message, but continue in the"
                                                                + " order as given in the odm file",
                                                            itemRef.getItemOID());
                                                    orderNumberForAllItemRefsPresent = false;
                                                } else {
                                                    LOGGER.debug(
                                                            "The ItemRef with OID {} has an OrderNumber, so I'll try"
                                                                    + " to put the referenced ItemDef onto its position"
                                                                    + " ({}) in the List",
                                                            itemRef.getItemOID(),
                                                            orderNumber.intValue());
                                                    if (orderedItemDefs.get(orderNumber.intValue()) == null) {
                                                        LOGGER.debug(
                                                                "The List of ItemDefs has a free spot at"
                                                                    + " position/OrderNumber {}, so I'll just put the"
                                                                    + " ItemDef of OID {} there.",
                                                                orderNumber.intValue(),
                                                                itemRef.getItemOID());
                                                        orderedItemDefs.put(
                                                                orderNumber.intValue(),
                                                        ...
                                                        LOGGER.debug(
                                                                "The List of ItemDefs already has an ItemDef at"
                                                                    + " position/OrderNumber {}, which does not comply"
                                                                    + " to the ODM standard. Will not consider"
                                            ...
                                            if (orderNumberForAllItemRefsPresent) {
                                                LOGGER.debug(
                                                        "All ItemDefs of MetaDataVersion of OID {} that were"
                                                                + " referenced in ItemGroupDef of OID {} have a unique"
                                                                + " OrderNumber in their ItemRef. Thus, I will consider"
                                                                + " the OrderNumbers when converting to Questions",
                                                        metaDataVersion.getOID(),
                                                        itemGroupDef.getOID());
                                                ArrayList<Integer> orderNumberList =
                                                        new ArrayList<>(orderedItemDefs.keySet());
                                                ...
                                                LOGGER.debug(
                                                        "Not all ItemDefs of MetaDataVersion of OID {} that were"
                                                                + " referenced in ItemGroupDef of OID {} have a unique"
                                                                + " OrderNumber in their ItemRef. Thus, I will not"
                                                                + " consider the OrderNumbers when converting to"
                                                                + " Questions",
                                                        metaDataVersion.getOID(),
                                                        itemGroupDef.getOID());
                                            ...
                                            for (ODMcomplexTypeDefinitionItemDef itemDef : itemDefListToIterateOver) {
                                                LOGGER.debug(
                                                        "Calling conversion " + "method for" + " ItemDef "
                                                                + "of OID {}.",
                                                        itemDef.getOID());
                                                ODMcomplexTypeDefinitionCodeListRef codeListRef =
                                                        itemDef.getCodeListRef();
                                                if (codeListRef == null) {
                                                    LOGGER.debug(
                                                            "The ItemDef with OID {} did not refer to a CodeListRef"
                                                                + " (getCodeListRef() == null), so I'll check for the"
                                                                + " DataType and create proper questions",
                                                            itemDef.getOID());
                                                    DataType dataType = itemDef.getDataType();
                                                    switch (dataType) {
                                                        case BOOLEAN: {
                                                            LOGGER.debug(
                                                                    "The DataType of ItemDef with OID {} was {}. Will"
                                                                        + " convert it into a simple multiple choice"
                                                            ...
                                                            // the internal
                                                            // separator
                                                            aggregatedExportFields.add(itemGroupDef
                                                                            .getOID()
                                                                            .replace(".", "u002E")
                                                                            .replace("_", "u005F")
                                                                    + "_"
                                                ...
                                                // of question type
                                                    ...
                                                    List<ODMcomplexTypeDefinitionCodeList> codeListList =
                                                            metaDataVersion.getCodeList();
                                                    if (codeListList == null) {
                                                        LOGGER.debug(
                                                                "The ItemDef with OID {} refers to a CodeList"
                                                                    + " (getCodeListRef() != null) with OID {}, but"
                                                                    + " the given MetaDataVersion with OID {} does not"
                                                        ...
                                                        LOGGER.debug(
                                                                "The ItemDef with OID {} refers to a CodeList"
                                                                    + " (getCodeListRef() != null) with OID {} and the"
                                                                    + " MetaDataVersion with OID {} contains a list of"
                                                                    + " CodeLists. Will now iterate over them to find"
                                                                    + " the referred one.",
                                                                itemDef.getOID(),
                                                                codeListOID,
                                                                metaDataVersion.getOID());
                                                        ...
                                                        for (ODMcomplexTypeDefinitionCodeList codeList : codeListList) {
                                                            LOGGER.debug(
                                                                    "checking CodeList with OID {}", codeList.getOID());
                                                            if (codeList.getOID()
                                                                    .equalsIgnoreCase(codeListOID)) {
                                                                LOGGER.debug(
                                                                        "CodeList with OID {} matched (ignoring cases)"
                                                                            + " the referenced CodeList ({}). Will"
                                                                            + " take this one for the answers of the"
                                                        ...
                                                        if (odmAnswerList == null) {
                                                            LOGGER.debug(
                                                                    "No matching CodeList could be found for the"
                                                                        + " referenced CodeList with OID {} in"
                                                                        + " MetaDataVersion with OID {} to create a"
                                                                        + " multiple choice question for ItemDef with"
                                                                        + " OID {}. Will create an error message and"
                                                                        + " finish",
                                                                    codeListOID,
                                                                    metaDataVersion.getOID(),
                                                                    itemDef.getOID());
                                                        } else {
                                                            for (ODMcomplexTypeDefinitionCodeListItem codeListItem :
