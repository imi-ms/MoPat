...
public class FhirR5Helper extends FhirHelper {
     ...
     * @param errors                        Stores the errors occuring during the validation
     *                                      process.
    ...
    public static boolean validateFileAgainstSchema(final MultipartFile fileToValidate,
        ...
        try {
            document = documentParser.parse(fileToValidate.getInputStream());
            ...
            try {
                ...
                errors.reject("import.fhir.validate.invalidFile",
     ...
     * object to FHIR questionnaireResponse item as HAPI
     * {@link QuestionnaireResponse.QuestionnaireResponseItemComponent} object.
     *
