...
public class FhirR4bToMoPatConverter {
    ...
    private static String setQuestionnaireTitleAndName(
        ...
        if (fhirQuestionnaire.getTitle() != null) {
            ...
            localizedDisplayNames =
                    FhirR4bHelper.getLanugageMapFromLanguageExtension(fhirQuestionnaire.getTitleElement());
    ...
    private static void doHandleChoiceAnswer(
        ...
        Entry<Double, Double> maxAndMinEntry = FhirR4bHelper.getMinAndMaxFromExtension(item, true);
        question.setQuestionType(QuestionType.MULTIPLE_CHOICE);
