...
public class FhirR5ToMoPatConverter {
    ...
    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(FhirR5ToMoPatConverter.class);
    ...
    private static String setQuestionnaireTitleAndName(
        ...
        if (fhirQuestionnaire.getTitle() != null) {
            ...
            localizedDisplayNames =
                    FhirR5Helper.getLanugageMapFromLanguageExtension(fhirQuestionnaire.getTitleElement());
     ...
     */
    private static List<QuestionnaireItemComponent> collectAllItems(Questionnaire fhirQuestionnaire) {
    ...
    private static void convertEnableWhenComponentsToConditions(
            List<QuestionnaireItemComponent> items, ImportQuestionnaireResult importQuestionnaire) {
    ...
    private static boolean hasOptionsOrDisplayOrTextOrCode(QuestionnaireItemComponent item) {
        return item.hasAnswerOption()
                || item.hasAnswerValueSet()
    ...
    private static void setLocalizedTextForQuestion(
        ...
        if (item.getText() != null) {
            localizedQuestionText = FhirR5Helper.getLanugageMapFromLanguageExtension(item.getTextElement());
            ...
            if (code.getDisplay() != null && !code.getDisplay().isEmpty()) {
                localizedQuestionText = FhirR5Helper.getLanugageMapFromLanguageExtension(code.getDisplayElement());
    ...
    private static void doHandleChoiceAnswer(
        ...
        Entry<Double, Double> maxAndMinEntry = FhirR5Helper.getMinAndMaxFromExtension(item, true);
        question.setQuestionType(QuestionType.MULTIPLE_CHOICE);
        ...
        boolean isOpenChoice = (item.getAnswerConstraint() == QuestionnaireAnswerConstraint.OPTIONSORSTRING);
        ...
        if (item.getAnswerValueSet() != null
        ...
        if (containedValueSet != null) {
            ...
            for (ValueSet.ConceptSetComponent conceptComponent :
                    containedValueSet.getCompose().getInclude()) {
        ...
        if (item.getAnswerConstraint() == QuestionnaireAnswerConstraint.OPTIONSORSTRING) {
            ...
            importQuestionResult.addValidationMessage("import.fhir.item.openchoice.otherFreetext");
                ...
                && (containedValueSet == null
                        || containedValueSet.getCompose() == null
        ...
        if (option instanceof Questionnaire.QuestionnaireItemAnswerOptionComponent item) {
            try {
                ...
                if (item.getValue() instanceof Coding) {
                    ...
                    localizedAnswerText = FhirR5Helper.getLanugageMapFromLanguageExtension(item.getValueStringType());
            ...
            localizedAnswerText = FhirR5Helper.getLanugageMapFromLanguageExtension(item.getDisplayElement());
    ...
    public static void convertEnableWhenToCondition(
        ...
        QuestionnaireItemComponent triggerItem = FhirR5Helper.getItemByLinkId(enableWhen.getQuestion(), items);
