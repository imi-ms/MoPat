    ...
    public void createOrUpdateAnswer(
        ...
        if (!answerDTO.getImageFile().isEmpty()) {
            ...
            String imageExtension =
                    FilenameUtils.getExtension(answerDTO.getImageFile().getOriginalFilename());
            String imagePath =
                    (controller.getConfigurationDao().getImageUploadPath() + "/question/" + questionnaire.getId());
            ...
            File uploadFile = new File(imagePath, "question" + question.getId() + "." + imageExtension);
            try {
                // Write the image to disk
                BufferedImage uploadImage =
                        ImageIO.read(answerDTO.getImageFile().getInputStream());
                ...
                result.rejectValue(
                        ...
                        controller
                                .getMessageSource()
                                .getMessage(
                                        "imageAnswer.error.upload", new Object[] {}, LocaleContextHolder.getLocale()));
            ...
            storagePath = questionnaire.getId() + "/question" + question.getId() + "." + imageExtension;
        } else {
