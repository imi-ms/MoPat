...
import de.imi.mopat.helper.controller.GitPropertiesHolder;
...
public class AdminController {
    ...
    @Autowired
    private GitPropertiesHolder gitPropertiesHolder;
    ...
    public String showAdmin(final Model model) {
        ...
        model.addAttribute("gitProperties", gitPropertiesHolder.getGitProperties());
        return "admin/index";
    }
