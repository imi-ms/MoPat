...
/**
 * The database table model for table <i>configuration</i>. The configuration object represent one
 * configurable attribute and its value. Due to validation every configuration object has a
 * configuration type.
 */
@Entity
...
public class Configuration implements Serializable {
    ...
    public ConfigurationDTO toConfigurationDTO() {
        ...
        configurationDTO.setId(this.getId());
        configurationDTO.setEntityClass(this.getEntityClass());
        configurationDTO.setAttribute(this.getAttribute());
        configurationDTO.setValue(this.getValue());
        configurationDTO.setConfigurationType(this.getConfigurationType());
        configurationDTO.setLabelMessageCode(this.getLabelMessageCode());
        configurationDTO.setDescriptionMessageCode(this.getDescriptionMessageCode());
        configurationDTO.setTestMethod(this.getTestMethod());
        ...
        if (this.getChildren() != null && !this.getChildren().isEmpty()) {
            ...
            for (Configuration child : this.getChildren()) {
                ConfigurationDTO childDTO = new ConfigurationDTO();
                childDTO.setId(child.getId());
                childDTO.setParent(configurationDTO);
                childrenDTOs.add(childDTO);
            }
            configurationDTO.setChildren(childrenDTOs);
        }
    ...
    /**
     * Returns the {@link ConfigurationGroup} object of the current configuration object.
     *
     * @return The {@link ConfigurationGroup} object of the current configuration.
     */
    ...
    /**
     * Sets the {@link ConfigurationGroup} object to the current configuration object.
     *
     * @param configurationGroup The {@link ConfigurationGroup} object to be set.
     */
    public void setConfigurationGroup(final ConfigurationGroup configurationGroup) {
        assert configurationGroup != null : "The given configurationGroup was null";
        this.configurationGroup = configurationGroup;
    }
     ...
     */
    public void setParent(final Configuration parent) {
        this.parent = parent;
    }
    ...
    public List<Configuration> getChildren() {
        if (this.children != null) {
            Collections.sort(children, new Comparator<Configuration>() {
                @Override
     ...
     */
    public void setChildren(final List<Configuration> children) {
