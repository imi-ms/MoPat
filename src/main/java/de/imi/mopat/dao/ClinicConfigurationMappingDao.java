...
public interface ClinicConfigurationMappingDao extends MoPatDao<ClinicConfigurationMapping> {
    ...
    /**
     * Returns true if UsePatientDataLookup toggle is activated and false otherwise. Get this boolean from the
     * {@link ClinicConfigurationMappingDao} by using the name of this class and the appropriate attribute name.
     *
    ...
    /**
     * Returns true if PseudonymizationService is activated and false otherwise. Get this boolean from the
     * {@link ClinicConfigurationMappingDao} by using the name of this class and the appropriate attribute name.
     *
