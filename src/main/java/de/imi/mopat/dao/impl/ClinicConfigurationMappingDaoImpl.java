...
@Component
public class ClinicConfigurationMappingDaoImpl extends MoPatDaoImpl<ClinicConfigurationMapping>
        implements ClinicConfigurationMappingDao {
    ...
    public List<ClinicConfigurationMapping> getAllElementsByClinicId(final Integer clinicId) {
        ...
        try {
            ...
            TypedQuery<ClinicConfigurationMapping> query =
                    moPatEntityManager.createQuery(jpql, ClinicConfigurationMapping.class);
    ...
    @Override
    public ClinicConfigurationMapping getConfigurationByAttributeAndClass(
    ...
    public Boolean isRegistryOfPatientActivated(final Long clinicId) {
        ClinicConfigurationMapping clinicConfigurationMapping =
                getConfigurationByAttributeAndClass(clinicId, Constants.REGISTER_PATIENT_DATA, Constants.CLASS_GLOBAL);
