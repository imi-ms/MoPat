 ...
 */
@Component
public class EncounterScheduledDaoImpl extends MoPatDaoImpl<EncounterScheduled> implements EncounterScheduledDao {
    ...
    @Override
    public List<EncounterScheduled> getFinishedEncounterScheduledOlderThan(final Timestamp timestamp) {
