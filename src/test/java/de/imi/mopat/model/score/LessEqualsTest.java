...
public class LessEqualsTest {
    ...
    private LessEquals lessEqualsOperator;
    private BinaryExpression binaryExpression;
    private Encounter encounter;

    /**
     * Returns a new valid instance of {@link LessEquals}
     *
     * @return New valid LessEquals instance
     */
    public static LessEquals getNewValidLessEquals() {
        return new LessEquals();
    }

    @Before
    public void setUp() {
        lessEqualsOperator = LessEqualsTest.getNewValidLessEquals();
    ...
    /**
     * Test of {@link LessEquals#evaluate}<br> Invalid input: value of first or second
    ...
    public void testEvaluate() {
        ...
        Boolean testValue = lessEqualsOperator.evaluate(binaryExpression, encounter);
        ...
        assertTrue("Evaluating failed. 42 was not lessequal 42.",
            lessEqualsOperator.evaluate(binaryExpression, encounter));

        expression1.setValue(3d);
        expression2.setValue(42d);
        assertTrue("Evaluating failed. 3 was not lessequal 42.",
            lessEqualsOperator.evaluate(binaryExpression, encounter));

        expression1.setValue(42d);
        expression2.setValue(3d);
        assertFalse("Evaluating failed. 42 was lessequal 3.",
            lessEqualsOperator.evaluate(binaryExpression, encounter));
        ...
        assertNull(
            ...
            lessEqualsOperator.evaluate(testBinaryExpression, encounter));
        testBinaryExpression.setOperator(lessEqualsOperator);
    ...
    /**
     * Test of {@link LessEquals#evaluate}<br> Invalid input: <code>null</code>, random
    ...
    public void testEvaluateWithWrongExpressions() {
        ...
        Boolean testValue = lessEqualsOperator.evaluate(expression, encounter);
        assertNull(
        ...
        testValue = lessEqualsOperator.evaluate(expression, encounter);
        assertNull(
            "Evaluating less equals failed. The returned value didn't match null although multi expression was used as param",
            testValue);

        testValue = lessEqualsOperator.evaluate(null, encounter);
        assertNull(
    ...
    /**
     * Test of {@link LessEquals#evaluate}<br> Invalid input: random {@link BinaryExpression} with
    ...
    public void testEvaluateExpressionsOutOfBounds() {
        ...
        testValue = lessEqualsOperator.evaluate(binaryExpression, encounter);
        assertNull(
    ...
    /**
     * Test of {@link LessEquals#getFormula}<br> Valid input: random {@link BinaryExpression} with
    ...
    public void testGetFormula() {
        ...
        String testFormula = lessEqualsOperator.getFormula(binaryExpression, encounter,
    ...
    /**
     * Test of {@link LessEquals#getFormula}<br> Invalid input: <code>null</code>, random
     * {@link UnaryExpression} and random {@link MultiExpression}
     */
    @Test
    public void testGetFormulaWithWrongExpressions() {
        Expression expression = UnaryExpressionTest.getNewValidUnaryExpression();
        String testFormula = lessEqualsOperator.getFormula(expression, encounter,
            Helper.getRandomLocale());
        assertNull(
            "Evaluating less equals failed. The returned value didn't match null although unary expression was used as param",
            testFormula);
        ...
        expression = MultiExpressionTest.getNewValidMultiExpression();
        testFormula = lessEqualsOperator.getFormula(expression, encounter,
            Helper.getRandomLocale());
        assertNull(
            "Evaluating less equals failed. The returned value didn't match null although multi expression was used as param",
            testFormula);

        testFormula = lessEqualsOperator.getFormula(null, encounter, Helper.getRandomLocale());
        assertNull(
            "Evaluating less equals failed. The returned value didn't match null although null was used as param",
            testFormula);
    }
    ...
    /**
     * Test of {@link LessEquals#getFormula}<br> Invalid input: random {@link BinaryExpression} with
     * more or less than two {@link UnaryExpression UnaryExpressions}
     */
    @Test
    public void testGetFormulaExpressionsOutOfBounds() {
        ...
        String testValue = lessEqualsOperator.getFormula(binaryExpression, encounter,
            Helper.getRandomLocale());
        assertNull(
        ...
        testValue = lessEqualsOperator.getFormula(binaryExpression, encounter,
            Helper.getRandomLocale());
        assertNull(
            "Evaluating less equals failed. The returned value didn't match null  although adhering expressions were less than 2",
            testValue);
