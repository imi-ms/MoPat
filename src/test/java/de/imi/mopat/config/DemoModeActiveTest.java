...
@TestPropertySource(
    ...
    properties = "de.imi.mopat.isDemoInstance=true"
)
@WebAppConfiguration
public class DemoModeActiveTest {
    ...
    @Test
    public void shouldShowDemoLoginValues() throws Exception {
        mockMvc.perform(get("/mobile/user/login"))
            .andExpect(status().isOk())
            .andExpect(content().string(containsString("value=\"admin\"")))
            .andExpect(content().string(containsString("value=\"admin123\"")))
